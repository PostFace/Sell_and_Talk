		...
		<tr align='center'>
			...
			if(mid!=null){
				if(mid.equals("admin")){ %>
								...
								|<a href="<%=cPath%>/shop/display/mallMain.jsp" class="head"
							>공식 판매 상품</a>
			...
			<td valign='top' align="left">
				<table width='200' style="text-align: left">
					...
					<tr width='200' height="40">
						<td><a href="<%=cPath%>/shop/board/list.jsp"
							style="color: #121517">잡담 게시판</a></td>
					</tr>
					<tr width='200' height="40">
						<td><a href="<%=cPath%>/shop/daily_board/list.jsp"
							style="color: #121517">데일리룩 게시판</a>
					</tr>
					<tr width='200' height="40">
						<td><a href="<%=cPath%>/shop/usedmall/prod_list.jsp"
							style="color: #121517">중고 상품 관리</a>
					</tr>
					<tr width='200' height="40">
						<td><a href="<%=cPath%>/shop/member/mypage.jsp"
							style="color: #121517">마이페이지</a></td>
					</tr>
					
				</table>
			</td>
			<td valign='top' align='center' width="1000" height="1500">
			</div>
</body>
