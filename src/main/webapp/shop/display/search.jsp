...
String[] spec = { "공식 판매 상품", "중고 상품" };
int count = 0;
String search = request.getParameter("search");
String[] cond = { "new", "used" };
%>
<br>
...
for (int i = 0; i < spec.length; i++) {
	ArrayList<ProductBean> prodList = pdao.getAllProductBySearch(search, cond[i]);
%>
...
<table width='600' align='center'>
	<tr align='center'>
		...
		%>
		<td><a href="mall_prodView.jsp?pnum=<%=pb.getPnum()%>"><img
